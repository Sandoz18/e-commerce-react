...
import styled, { keyframes } from 'styled-components'; // UIverse
import 'bootstrap/dist/css/bootstrap.min.css';
import styles from './SocialMediaIcons.module.css'

// 1. Define tu animación usando la función `keyframes`
...
const SocialMediaIcons = ({onClose}) => {
  ...
  return (
    <StyledWrapper>
      ...
      <div className="card">
           {onClose && ( // Solo muestra el botón si se proporciona una función onClose
            <button 
              type="button" 
              className={`btn-close ${styles.closeButton}`} // Usamos btn-close de Bootstrap y nuestra clase personalizada del CSS Module
              aria-label="Cerrar"
              onClick={onClose}
            ></button>
          )}
